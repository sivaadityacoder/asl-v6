...
export default function RepositoriesPagePage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Repositories</h1>
        <p className="text-muted-foreground mt-1">Connect and manage your GitHub repositories</p>
      </div>
      <Card>
        <CardHeader>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-center h-48 rounded-lg border border-dashed border-border bg-muted/30">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Repositories content area</p>
            </div>
          </div>
          <Button asChild>
