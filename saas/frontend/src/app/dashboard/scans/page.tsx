...
export default function ScansPagePage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Scans</h1>
        <p className="text-muted-foreground mt-1">View and manage your security scan history</p>
      </div>
      <Card>
        <CardHeader>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-center h-48 rounded-lg border border-dashed border-border bg-muted/30">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Scans content area</p>
            </div>
          </div>
          <Button asChild>
